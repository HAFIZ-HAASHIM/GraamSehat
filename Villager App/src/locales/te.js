...
export default {
  ...
  login: {
    ...
    subheadline: 'దయచేసి మీ 8-అంకెల ప్రత్యేక ఆరోగ్య ఐడిని క్రింద నమోదు చేయండి.',
  ...
  addFamily: {
    ...
    explain: 'మీ కుటుంబ సభ్యుడి ఖాతాను ఈ పరికరానికి లింక్ చేయడానికి వారి 8-అంకెల ఆరోగ్య ఐడిని నమోదు చేయండి.',
